...
End-to-end procedure: from the ScreenFlow project file to a single .mp4 carrying
toggleable English / Swedish / Spanish / German subtitle tracks.
...
## Stage 4 — Attach every subtitle track to the video
